...
public class StringUtils extends org.apache.commons.lang3.StringUtils{
    ...
    /**
     * Convert SomeStuff to some_stuff to
     *
     * @param s input string
     * @return underlined string
     */
    final static Pattern pattern = Pattern.compile("([A-Z]*[^A-Z]+)");
    ...
    final static Pattern pattern2 = Pattern.compile("([A-Z|:]*[^A-Z:]+)");
    final static Pattern pattern_json = Pattern.compile("^[A-Z]+[^,]*");

    public static String underlining_json(String s) {
        List<String> words = new ArrayList<>();
        Matcher matcher = pattern2.matcher(s);
        while (matcher.find()) {
            words.add(matcher.group());
        }
        words = words.stream().map(one -> {
            Matcher matcherJson = pattern_json.matcher(one);
            if (matcherJson.matches()) {
                String first = one.substring(0,1);
                return "_" + one.replaceFirst(first,first.toLowerCase());
            } else {
                return one;
            }
    ...
    public static void main(String[] args) {
        String json = "{\"success\":true,\"message\":\"KEEP FIT SALAD  轻食沙拉\",\"data\":{\"programId\":1113361,\"S\":\"cgxhchvxgcj\",\"summary\":null,\"pCount\":2,\"status\":1,\"series\":[{\"roomId\":47623,\"finishTime\":null,\"subject\":\"第1期 \",\"status\":8,\"productId\":null},{\"roomId\":47624,\"finishTime\":null,\"subject\":\"第2期 \",\"status\":8,\"productId\":null}],\"verticalCover\":\"http://pic.mixiong.tv/uploadImages/d648e0c45508175f8050212c4e267a1d/1504493852156.png\",\"horizontalCover\":\"http://pic.mixiong.tv/uploadImages/d648e0c45508175f8050212c4e267a1d/1504269554454program_cover.jpg\",\"startTime\":1504270859000,\"user\":{\"passport\":\"x30\",\"nickname\":\"王者荣耀进哦哦你\",\"avatar\":\"http://pic.mixiong.tv/uploadImages/d648e0c45508175f8050212c4e267a1d/1504267128673x30.jpg\",\"signature\":null,\"verifyType\":null,\"verifyInfo\":null,\"isCelebrity\":false,\"description\":null,\"personalDetails\":null,\"celebrityType\":null,\"isVerified\":null,\"celebrity\":false},\"productId\":2,\"isPurchased\":false,\"purchased\":false,\"pcount\":2}}";
//        System.out.println(json);
//        System.out.println(StringUtils.underlining(json));
        System.out.println(StringUtils.underlining_json(json));
    }
}
